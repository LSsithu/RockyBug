//base by Master Rocky
//re-upload? recode? copy code? give credit  :)
//YouTube: @OTM_Rocky
//WhatsApp:  https://wa.me/message/25CCB2QXLEORJ1
//want more free bot scripts? subscribe to my youtube channel: https://www.youtube.com/@OTM_Rocky
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By Rocky Bot Owner ${ownername} For more  Hacks Search On Rocky `).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/k2K9VGn/thumb.jpg',
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}\n Premium is free! \n Put Your number in Premium json in file! \n do not know check video on Youtube channel Master Rocky .`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `Athal Ekata BUG Gahala Ahu Unoth Kana palanawa 🚫`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF Rocky  is on YouTube Master Rocky ❤️`,
                            body: `Love You 😘`,
                            thumbnailUrl: 'https://i.ibb.co/k2K9VGn/thumb.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
...
case "xandroid": {
  ...
  replygcxeon("please wait, " + command + " Master Rocky BUG is in process..");
...
case "xios2":
  ...
  case "xgc":
  {
    if (!isPremium) return replygcxeon(mess.prem)
    if (!text) {
      return replygcxeon("*HOW TO SEND Master Rocky BUG TO GROUP*\n\n" + (prefix + command) + " https://chat.whatsapp.com/xxxx\n\n_*Note:*_ If you want to send a large number of bugs, please type as follows\n\nEx: ." + command + " linkgc amount\n\nExample:\n." + command + " https://chat.whatsapp.com/xxxx 10");
    }
    replygcxeon("please wait, " + command + " Master Rocky BUG is in process..");
...
xeonimun('*Ｆᴏʀ ＳᴛΔᵀᴜs Ｖɪᴠᴇs "🙇🏻‍♀️❤️🖇️* \n👨🏻‍💻 *Name*: Sithum(Rocky)  \n 🏡 *From*: Anuradhapura   \n 🎂 *Age*: 18 (2006) \n _http://www.tiktok.com/@alone_sithu28_ \n _https://wa.me/message/25CCB2QXLEORJ1_❤️')
case 'alive':
xeonimun('🌟 *Name*: Sithum \n 🌍 *From*: Anuradhapura   \n\n 🎂 *Age*: 18   \n _https://wa.me/message/25CCB2QXLEORJ1')
break
case 'ping':
xeonimun('🌟 *Name*: Sithum \n 🌍 *From*: Anuradapura   \n\n 🎂 *Age*: 18   \n _https://wa.me/message/25CCB2QXLEORJ1')
break
